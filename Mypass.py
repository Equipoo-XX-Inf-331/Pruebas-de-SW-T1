...
def insert_user(conn, id_user, nombre, main_password):
    ...
    try:
        ...
        logging.error("Error al insertar usuario:", e)
...
def get_user(conn, id_user):
    ...
    try:
        ...
        if row:
            ...
            logging.warning("No se encontró ningún usuario con el ID proporcionado.")
            return None
    except Error as e:
        logging.error("Error al obtener el nombre de usuario:", e)
        return None
...
def main():
    ...
    if conn is not None:
        ...
        logging.error("Error! no se pudo crear la conexión a la base de datos.")
        return None 
...
if __name__ == '__main__':
    ...
    if conn is not None:
        ...
        if count_users(conn) == 0:
            ...
            insert_user(conn, 1, user, Hash_bd) #el msj lo imprime la funcion directamente
        ...
        if count_users(conn) == 1:
            ...
            while corte == False:
                ...
                if Hash == hash_bd:
                    ...
                    logging.info("Contraseña incorrecta, porfavor volver a intentar.\n")
            ...
            while ciclo:
                ...
                if opcion == "1":
                    ...
                    if view_password(sitio_lower) == False:
                        ...
                        print("")
                        logging.info("Ya hay una contraseña registrada para "+ sitio + ".\n")
                    ...
                    if view_password(sitio_lower):
                        ...
                        logging.info("Contraseña encontrada:\n")
                        print("La contraseña para " + sitio +" es: " + contra_de_vuelta +"\n")
                    else:
                        logging.info(sitio + " no se ha encontrado en la base de datos.\n")
        ...
        if count_users(conn) > 1:
            logging.error("Este programa tiene bloqueada la posibilidad de tener mas de un usuario y actualmente se encuentra en esa situación, se tiene que borrar la base de datos debido a que no se puede asegurar la integridad de estos mismos")
    else:
        logging.error("Error al establecer la conexión.")